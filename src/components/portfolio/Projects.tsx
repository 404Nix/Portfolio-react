...
const projects = [
  {
    ...
    technologies: ["Next.js", "TypeScript", "Convex", "Clerk", "Tailwind CSS"],
  ...
  },
  {
    ...
    description:
      " Developed a single-page application (SPA) for managing employee tasks and data. Demonstrates frontend best practices and localStorage optimization.",
